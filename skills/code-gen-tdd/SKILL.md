...
argument-hint: --feature-dir <path> [--feature-id F-001] [--skip-unit-tests=false] [--auto-comit]
---
...
/code-gen-tdd --feature-dir req/create-order --auto-comit
```
...
```json
{
  ...
  "featureDir": "<需求目录>",
  "featureId": "<可选功能 ID>",
  "options": { "skipUnitTests": true, "autoCommit": true }
}
```

`--auto-comit` 在成功完成后自动提交并推送当前仓库的所有变更，包括未跟踪的新增代码和测试文件。`--auto-commit` 与其等价。
